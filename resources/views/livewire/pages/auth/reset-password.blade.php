    ...
    <form wire:submit="resetPassword">
        ...
        <flux:card class="space-y-6">
            <div>
                ...
                <flux:subheading>Enter your new password to regain access to your account</flux:subheading>
            </div>
            ...
            <flux:button variant="primary" class="w-full" type="submit">Reset Password</flux:button>
        </flux:card>
    </form>
</div>
